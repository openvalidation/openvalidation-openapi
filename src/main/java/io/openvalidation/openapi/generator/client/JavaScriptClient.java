...
public class JavaScriptClient extends JavascriptClientCodegen implements CodegenConfig {
  ...
  public String getName() {
    return "ov-javascript-client";
  }

  @Override
  public String getHelp() {
    return "Generates a JavaScript client library including validation rules generation (>= java 1.8 ). powered by openVALIDATION.";
  }

  public JavaScriptClient() {
    super();

    this.setProjectVersion("0.0.1");
  }
  ...
  public Map<String, Object> postProcessOperationsWithModels(
    ...
    if (ovCodegen == null) {
      String validationFolder = sourceFolder.replace('\\', '/') + "/validation";
    ...
    ovCodegen.generateOVSingleFile(globalOpenAPI, api);
